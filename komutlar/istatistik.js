...
module.exports = {
  ...
  async run (bot, message, args) {
   ...
   const kafkazaman = moment.duration(bot.uptime).format(" D [gün], H [saat], m [dakika], s [saniye]");
   const kafkaistatistikler = new Discord.MessageEmbed()
  .setColor("#66ff00")
  ...
  .addField("<a:yakarok:823103196494561290>**Çalışma süresi**", kafkazaman)
 ...
 return message.channel.send(kafkaistatistikler);
  }
}
